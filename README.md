...
A ISO preservada está disponível na seção **Releases** deste repositório.

👉 **[Baixar o Sunsix Linux](../../releases)**

Antes de utilizar a imagem, recomenda-se verificar o checksum disponibilizado junto ao release.
